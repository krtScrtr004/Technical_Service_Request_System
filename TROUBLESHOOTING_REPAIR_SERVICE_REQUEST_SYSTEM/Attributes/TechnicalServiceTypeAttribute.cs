...
{
    public class SelectTechnicalServiceRequestTypeAttribute : ValidationAttribute
    {
        private readonly string _otherPropertyName;

        public SelectTechnicalServiceRequestTypeAttribute(string otherPropertyName = "Others")
        {
    ...
    public class ValidLivestreamScheduleAttribute : ValidationAttribute
    {
        ...
        public ValidLivestreamScheduleAttribute(string serviceTypeProperty = "TechnicalServiceTypeId")
        {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            else if (selectedServiceTypeValue == (int)TechnicalServiceTypeEnum.LIVESTREAM_SETUP)
            {
